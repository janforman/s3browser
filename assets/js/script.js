        ...
        fileList.show();
			...
			if(scannedFiles.length) {
				...
				scannedFiles.forEach(function(f) {
					...
					var file = $('<li class="files"><a href="'+ f.path +'" title="'+ f.path +'" class="files" data-type="video" data-fancybox data-caption="' + name + '">'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');
